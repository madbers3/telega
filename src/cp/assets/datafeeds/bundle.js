        ...
        try {
            ...
            for (; symbolIndex < symbolsCount; ++symbolIndex) {
                ...
                var symbolInfo = {
                    ...
                    intraday_multipliers: definedValueOrDefault(extractField$1(data, 'intraday-multipliers', symbolIndex, true), ['5', '15', '30', '60', '240', '720', '1D', '1W', '1M']),
...
function defaultConfiguration() {
    return {
        ...
        supported_resolutions: ['5', '15', '30', '60', '240', '720', '1D', '1W', '1M'],
